...
#+BEGIN_SRC 
compset -P '*,'
_alternative 'dirs:comma separated directories:_path_files -/ -S ,'
#+END_SRC
Note: this uses the compset builtin which allows you to manipulate how the shell treats completions. 
